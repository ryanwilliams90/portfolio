...
5. **Failure modes** — how the system degrades and what it does about it.
...
- [`03-agent-identity-mcp-plane.md`](./03-agent-identity-mcp-plane.md) — Agent Identity and MCP Credential Plane *(Prototype)*
- [`04-provenance-attestation.md`](./04-provenance-attestation.md) — Cryptographic Provenance for AI-Assisted Code *(Architecture study)*
